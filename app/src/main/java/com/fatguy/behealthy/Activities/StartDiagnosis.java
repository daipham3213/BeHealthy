...
public class StartDiagnosis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(StartDiagnosis.this, "Hello", Toast.LENGTH_SHORT).show();
        Button star = findViewById(R.id.diaggonsis_btn_start);
        AutoCompleteTextView auto = findViewById(R.id.diaggonsis_autotxt_input);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,COUNTRiIES);
        ...
        star.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity( new Intent(StartDiagnosis.this, Diaggonsis.class));

            }
        });

    }
    private static String [] Fomat (String a[] ){
    ...
    private static String [] COUNTRiIES = new String[]{
